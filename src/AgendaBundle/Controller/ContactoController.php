...
use AgendaBundle\Entity\Contacto;
use AgendaBundle\Form\ContactoType;
...
class ContactoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AgendaBundle:Contacto')->findAll();

        return $this->render('AgendaBundle:Contacto:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AgendaBundle:Contacto:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AgendaBundle:Contacto')->find($id);
        ...
        return $this->render('AgendaBundle:Contacto:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AgendaBundle:Contacto:edit.html.twig', array(
            'entity'      => $entity,
